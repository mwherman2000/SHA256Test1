...
namespace SHA256Test1
{
    public class HashDirectory
    {
        ...
        public static void Main(String[] args)
        {
            ...
            //Console.WriteLine();
            //foreach (string s in Terms.ORBs)
            //{
            //    byte[] hash2 = mySHA256.ComputeHash(Encoding.ASCII.GetBytes(s.ToLower()));
            //    int red = (int)hash2[0];
            //    int green = (int)hash2[1];
            //    int blue = (int)hash2[2];
            //    int red2 = (red >> 3) << 3;
            //    int green2 = (green >> 3) << 3;
            //    int blue2 = (blue >> 3) << 3;
            //    Console.Write($"\"{s.ToLower()}\",{red},{green},{blue},{red2},{green2},{blue2},,,");
            //    PrintByteArray(hash2);
            //}

            Console.WriteLine();
            foreach (string s in Terms.Topics)
            {
                byte[] hash2 = mySHA256.ComputeHash(Encoding.ASCII.GetBytes(s.ToLower()));
                int red = (int)hash2[0];
                int green = (int)hash2[1];
        ...
        public static void PrintByteArray(byte[] array)
        {
            ...
            for (i = 0; i < array.Length; i++)
            {
                ...
                if ((i % 4) == 3 && i != array.Length - 1) Console.Write(" ");
            }
            Console.WriteLine("\"");
        }
    }
